...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark p-2" style="background-color: #2961AE;">
        <div class="container">
            <a class="navbar-brand align-text-center fs-2 d-flex align-items-center fw-semibold " href="#">
                <img src="assets/logoputih.png" alt="" height="50" class="d-inline-block me-3">Daftar Karyawan
                PTGM</a>
            </a>
    ...
    <div class="container">
        ...
        <div class="row my-3">
            <div class="col-6">
                <div>
                    <form class="d-flex align-items-center" method="post" action="karyawan.php">
                    ...
                    <table class="table table-borderless text-center ">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row["NIK"]; ?></td>
                                <td>
                                    <a href="confkaryawan/ubah_karyawan.php?kode=<?= $row["Kode"] ?>" title="Ubah"><img
                                            src="assets/ubah.svg" class="me-3" alt=""></a>Atau
                                    <a onclick="return confirm('Yakin ?');"
                                        href="confkaryawan/hapus_karyawan.php?kode=<?= $row["Kode"] ?>"
                                        title="Hapus"><img src="assets/delete.svg" class="ms-3" alt=""></a>
                                </td>
                            </tr>
                            <?php endforeach ?>
